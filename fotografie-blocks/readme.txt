...
= 1.1.1 (Released: September 27, 2024) =
* Bug Fixed: Mini cart icon color issue
* Bug Fixed: Excerpt link color issue
* Updated: Style for mini cart icon

= 1.1 (Released: September 25, 2024) =
* Bug Fixed: Search result issue
* Bug Fixed: Mini cart and Customer account icon design issue in header
* Updated: Huge and normal font size slug in theme json conflicting with WordPress default naming
* Updated: Design issues in Checkout and My Account

= 1.0.6 (Released: September 13, 2024) =
* Updated: WordPress 6.6 ready

= 1.0.5 (Released: April 22, 2024) =
* Updated: WordPress 6.5 ready

= 1.0.4 (Released: March 19, 2024) =
* Added: Info buttons and message
* Removed: Unnecessary index.php file

= 1.0.3 (Released: March 12, 2024) =
* Replaced: Search a Keyword... with Enter keyword...
